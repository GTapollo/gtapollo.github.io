...
layout: blog
title:  "像哈特尔一样写博客"
subtitle: "Write blogs like Harttle"
categories: admin
tags: web
---
##First step on Rockland.
本网站fork自harttle.github.io，原作者Harttle。H君是我在北大读本科时的室友，与我同是下铺。
我是由于不熟悉科学网的排版，而决定自己做自己的博客的，本博客主要写下科研碎笔，包括一些技术性实现以及自己的小看法。任何言语除表明出处，皆仅代表个人观点。
